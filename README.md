...
Extension 1: Early Warnings

 Introduces a 'warning' level with a tolerance of 5% of the upper-limit.
...
Note: Though we are starting with warning levels for all parameters, customers may give feedback to have warnings only for some parameters and not others. Minimize the change needed for such 'tuning'.
